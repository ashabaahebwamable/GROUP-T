...
| `records/suppliers.csv`    | 6 suppliers              | Synthetic, team-authored | Azibo Isaac Alinda (initial repository author) | 2026-09-07 baseline | Includes one excluded supplier for the policy test                             |
...
| ------------------------------------------ | ---------------- | ------------------------ | ---------------------------------------------- | ------------------- | ------------------------------------------------------------ |
| `policy/procurement-policy.md`             | Policy           | Synthetic, team-authored | Azibo Isaac Alinda (initial repository author) | 2026-09-07 baseline | Primary retrieval target for grounded policy questions       |
...
- [ ] Expand inventory to ~150 SKUs (owner to be assigned in Week 2)
